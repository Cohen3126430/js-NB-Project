...
ברוכים הבאים לאתר החנות שלכם! פרויקט זה מציג פלטפורמת חנות אינטרנטית הכוללת גלריה עם אפשרות מיון, רשימת משאלות אישית, סל קניות, ותצוגת פרטי מוצר – כולן עובדות בצורה אינטראקטיבית ,ובהתאמה לכל סוגי המסכים.
...
- תצוגת פרטי מוצר עם קישור חזרה לקטגוריה \רכישה
- הודעה מוצגת כשהרשימה ריקה
- הכל מוצג בעברית (RTL) אתר רספונסיבי ,ומתאים לניידים
...
- `wishlist.html` – רשימת המשאלות עם אפשרות להסרה\ רכישה
- `cart.html` –  סל הקניות עם כפתורי כמות וחישוב מחיר
